...
const tabsListVariants = cva(
  "rounded-lg p-[3px] group-data-[orientation=horizontal]/tabs:h-9 group/tabs-list text-muted-foreground inline-flex w-fit items-center justify-center group-data-[orientation=vertical]/tabs:h-fit group-data-[orientation=vertical]/tabs:flex-col",
  {
    variants: {
      variant: {
        default: "bg-muted",
        underline: "bg-transparent w-full h-auto p-0 gap-8 justify-start",
      },
    },
    defaultVariants: {
      variant: "default",
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "group-data-[variant=underline]/tabs-list:rounded-none group-data-[variant=underline]/tabs-list:border-b-2 dark:group-data-[variant=underline]/tabs-list:border-foreground/50 group-data-[variant=underline]/tabs-list:pb-2 group-data-[variant=underline]/tabs-list:px-4 group-data-[variant=underline]/tabs-list:flex-1 group-data-[variant=underline]/tabs-list:text-lg group-data-[variant=underline]/tabs-list:font-medium group-data-[variant=underline]/tabs-list:data-[state=active]:bg-transparent group-data-[variant=underline]/tabs-list:data-[state=active]:border-primary group-data-[variant=underline]/tabs-list:data-[state=active]:border-b-[3px] group-data-[variant=underline]/tabs-list:data-[state=active]:text-primary group-data-[variant=underline]/tabs-list:data-[state=active]:shadow-none",
        className,
      )}
      {...props}
    />
